...
//        e.g https://github.com/VaibhvPatel/events-app-api-server.git might become https://github.com/MyName/external.git
// variables:
// The following are common to both api-server and web-server
//      roidtc-july2022-u420
...
//      https://github.com/VaibhvPatel/events-app-api-server.git
//	    main
//      api-server-image
...
pipeline {
   ...
   environment {
        ...
        imageName = 'vaibhavdocker615/api-server-image'
        dockerImage = ''
        }
    stages {
        stage('Get Source') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/VaibhvPatel/events-app-api-server.git'
        ...
        stage('Deploy Image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials events-app-cluster --zone us-central1-c --project roidtc-july2022-u420'
            }
        }     
         stage('update k8s') {
             agent {
